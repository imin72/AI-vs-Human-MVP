...
const ENGLISH_BASE: TranslationData = {
  ...
  topics: {
    ...
    subtopics: {
      ...
      [TOPIC_IDS.SCIENCE]: ["Quantum Physics", "Genetics", "Organic Chemistry", "Neuroscience", "Botany", "Astronomy", "Geology", "Thermodynamics", "Marine Biology", "Evolution", "Particle Physics", "Immunology", "Paleontology", "Climate Science", "Robotics", "Ecology"],
      [TOPIC_IDS.ARTS]: ["Impressionism", "Renaissance Art", "AI Art & Prompt Design", "Surrealism", "Digital Illustration", "Modernism", "Sculpture", "Graphic Design", "Fashion Core Trends", "Mobile Photography", "Street Art", "Immersive Art Experiences", "Abstract Expressionism", "Ceramics Revival", "Modern Calligraphy", "Gothic Architecture"],
      [TOPIC_IDS.GENERAL]: ["AI Regulation", "Creator Economy", "Inventions", "World Capitals", "Currencies", "Nobel Prizes", "Phobias", "Brand Logos", "Cryptocurrency", "Viral Trends", "Board Games", "Card Games", "Superheroes", "Digital Wellbeing", "AI Agents", "EV Brands"],
      [TOPIC_IDS.GEOGRAPHY]: ["Capitals", "Landmarks", "Mountains", "Rivers", "Deserts", "Islands", "Volcanoes", "Flags", "Population Stats", "Climate Zones", "Oceans", "US States", "European Countries", "Asian Cities", "African Nations", "Geopolitical Hotspots"],
      [TOPIC_IDS.MOVIES]: ["Oscars", "Sci-Fi", "Horror", "Marvel Cinematic Universe", "Star Wars", "Pixar", "Streaming Originals", "Franchise Reboots", "Famous Directors", "Movie Soundtracks", "Cult Classics", "Anime Movies", "French Cinema", "A24 & Indie Cinema", "Special Effects", "Movie Villains"],
      [TOPIC_IDS.MUSIC]: ["Rock & Roll", "Pop Music", "Jazz", "Classical", "Hip Hop", "K-Pop", "EDM", "Heavy Metal", "Blues", "Country", "Opera", "Musical Instruments", "90s Hits", "One Hit Wonders", "Music Theory", "TikTok Hits"],
      [TOPIC_IDS.GAMING]: ["Nintendo", "PlayStation", "Xbox", "PC Gaming", "RPGs", "FPS", "Live Service Games", "Retro Gaming", "Esports", "Minecraft", "Pokemon", "Zelda", "Mario", "Indie Games", "UGC Platforms", "Cross-Platform Gaming"],
      ...
      [TOPIC_IDS.TECH]: ["Artificial Intelligence", "Smartphones", "Cloud Computing", "Social Media", "Coding", "Cybersecurity", "Space Tech", "Spatial Computing", "Blockchain", "Robots", "Computer Hardware", "Big Data", "Startups", "Hackers", "Gaming Tech", "Generative AI Apps"],
      [TOPIC_IDS.MYTHOLOGY]: ["Greek Mythology", "Norse Mythology", "Egyptian Mythology", "Roman Mythology", "Japanese Folklore", "Chinese Mythology", "Celtic Mythology", "Aztec Mythology", "Hindu Mythology", "Native American", "Legendary Monsters", "Epic Heroes", "Underworlds", "Creation Myths", "Divine Pantheons", "Tricksters"],
      [TOPIC_IDS.LITERATURE]: ["Shakespeare", "Classic Novels", "Dystopian Fiction", "Fantasy", "Sci-Fi Books", "Poetry", "Horror", "Mystery", "Comics & Manga", "Nobel Laureates", "Fairy Tales", "Greek Epics", "Russian Literature", "American Literature", "British Literature", "Web Novels"],
      [TOPIC_IDS.NATURE]: ["Mammals", "Birds", "Insects", "Marine Life", "Dinosaurs", "Rain Forests", "Deserts", "Extreme Weather", "Flowers", "Trees", "National Parks", "Survival Skills", "Evolution", "Endangered Species", "Fungi", "Gems & Minerals"],
      [TOPIC_IDS.FOOD]: ["Italian Cuisine", "French Cuisine", "Mexican Food", "Japanese Food", "Chinese Food", "Indian Food", "Korean Cuisine", "Desserts", "Wine", "Specialty Coffee", "High-Protein Meals", "Street Food", "Fast Food", "Baking", "Vegan", "Zero-Proof Drinks"],
...
const KO_TRANSLATIONS: TranslationData = {
  ...
  topics: {
    ...
    subtopics: {
      ...
      [TOPIC_IDS.SCIENCE]: ["양자 역학", "유전학", "유기 화학", "신경 과학", "식물학", "천문학", "지질학", "열역학", "해양 생물학", "진화론", "입자 물리학", "면역학", "고생물학", "기후 과학", "로봇 공학", "생태학"],
      [TOPIC_IDS.ARTS]: ["인상주의", "르네상스 예술", "AI 아트 & 프롬프트 디자인", "초현실주의", "디지털 일러스트레이션", "모더니즘", "조각", "그래픽 디자인", "패션 코어 트렌드", "모바일 사진", "스트리트 아트", "몰입형 아트 경험", "추상 표현주의", "세라믹 리바이벌", "모던 캘리그래피", "고딕 건축"],
      [TOPIC_IDS.GENERAL]: ["AI 규제", "크리에이터 이코노미", "발명품", "세계 수도", "통화", "노벨상", "공포증", "브랜드 로고", "암호화폐", "바이럴 트렌드", "보드 게임", "카드 게임", "슈퍼히어로", "디지털 웰빙", "AI 에이전트", "EV 브랜드"],
      [TOPIC_IDS.GEOGRAPHY]: ["수도", "랜드마크", "산맥", "강", "사막", "섬", "화산", "국기", "인구 통계", "기후대", "대양", "미국 주", "유럽 국가", "아시아 도시", "아프리카 국가", "지정학적 핫스팟"],
      [TOPIC_IDS.MOVIES]: ["오스카", "SF", "공포", "마블 시네마틱 유니버스", "스타워즈", "픽사", "스트리밍 오리지널", "프랜차이즈 리부트", "유명 감독", "영화 사운드트랙", "컬트 클래식", "애니메이션 영화", "프랑스 영화", "A24 & 인디 시네마", "특수 효과", "영화 빌런"],
      [TOPIC_IDS.MUSIC]: ["락앤롤", "팝 음악", "재즈", "클래식", "힙합", "K-팝", "EDM", "헤비 메탈", "블루스", "컨트리", "오페라", "악기", "90년대 히트곡", "원 히트 원더", "음악 이론", "틱톡 히트곡"],
      [TOPIC_IDS.GAMING]: ["닌텐도", "플레이스테이션", "엑스박스", "PC 게임", "RPG", "FPS", "라이브 서비스 게임", "레트로 게임", "e스포츠", "마인크래프트", "포켓몬", "젤다", "마리오", "인디 게임", "UGC 플랫폼", "크로스플랫폼 게임"],
      [TOPIC_IDS.SPORTS]: ["축구", "농구", "야구", "테니스", "골프", "포뮬러 1", "올림픽", "복싱", "MMA", "크리켓", "럭비", "수영", "겨울 스포츠", "스케이트보드", "레슬링", "월드컵"],
      [TOPIC_IDS.TECH]: ["인공지능", "스마트폰", "클라우드 컴퓨팅", "소셜 미디어", "코딩", "사이버 보안", "우주 기술", "공간 컴퓨팅", "블록체인", "로봇", "컴퓨터 하드웨어", "빅데이터", "스타트업", "해커", "게이밍 기술", "생성형 AI 앱"],
      [TOPIC_IDS.MYTHOLOGY]: ["그리스 신화", "북유럽 신화", "이집트 신화", "로마 신화", "일본 설화", "중국 신화", "켈트 신화", "아즈텍 신화", "힌두 신화", "북미 원주민", "전설의 괴물", "서사시 영웅", "지하 세계", "창세 신화", "신들의 판테온", "트릭스터"],
      [TOPIC_IDS.LITERATURE]: ["셰익스피어", "고전 소설", "디스토피아 소설", "판타지", "SF 도서", "시", "공포", "미스터리", "만화 및 망가", "노벨 문학상", "동화", "그리스 서사시", "러시아 문학", "미국 문학", "영국 문학", "웹소설"],
      [TOPIC_IDS.NATURE]: ["포유류", "조류", "곤충", "해양 생물", "공룡", "열대 우림", "사막", "극한 기상", "꽃", "나무", "국립공원", "생존 기술", "진화", "멸종 위기종", "균류", "보석 및 광물"],
      [TOPIC_IDS.FOOD]: ["이탈리아 요리", "프랑스 요리", "멕시코 음식", "일본 음식", "중국 음식", "인도 음식", "한식", "디저트", "와인", "스페셜티 커피", "고단백 식단", "길거리 음식", "패스트 푸드", "베이킹", "비건", "논알코올 음료"],
...
const JA_TRANSLATIONS: TranslationData = {
  ...
  topics: {
    ...
    subtopics: {
      ...
      [TOPIC_IDS.SCIENCE]: ["量子力学", "遺伝学", "有機化学", "神経科学", "植物学", "天文学", "地質学", "熱力学", "海洋生物学", "進化論", "素粒子物理学", "免疫学", "古生物学", "気候科学", "ロボット工学", "生態学"],
      [TOPIC_IDS.ARTS]: ["印象派", "ルネサンス美術", "AIアート＆プロンプトデザイン", "シュルレアリスム", "デジタルイラスト", "モダニズム", "彫刻", "グラフィックデザイン", "ファッションコアトレンド", "モバイルフォトグラフィー", "ストリートアート", "没入型アート体験", "抽象表現主義", "セラミックリバイバル", "モダンカリグラフィー", "ゴシック建築"],
      [TOPIC_IDS.GENERAL]: ["AI規制", "クリエイターエコノミー", "発明", "世界の首都", "通貨", "ノーベル賞", "恐怖症", "ブランドロゴ", "暗号資産", "バイラルトレンド", "ボードゲーム", "カードゲーム", "スーパーヒーロー", "デジタルウェルビーイング", "AIエージェント", "EVブランド"],
      [TOPIC_IDS.GEOGRAPHY]: ["首都", "ランドマーク", "山脈", "川", "砂漠", "島", "火山", "国旗", "人口統計", "気候帯", "海洋", "米国の州", "欧州の国々", "アジアの都市", "アフリカの諸国", "地政学ホットスポット"],
      [TOPIC_IDS.MOVIES]: ["オスカー", "SF", "ホラー", "マーベル・シネマティック・ユニバース", "スター・ウォーズ", "ピクサー", "ストリーミングオリジナル", "フランチャイズ・リブート", "有名監督", "映画音楽", "カルト・クラシック", "アニメ映画", "フランス映画", "A24・インディーシネマ", "特殊効果", "映画のヴィラン"],
      [TOPIC_IDS.MUSIC]: ["ロックンロール", "ポップ・ミュージック", "ジャズ", "クラシック", "ヒップホップ", "K-POP", "EDM", "ヘヴィメタル", "ブルース", "カントリー", "オペラ", "楽器", "90年代ヒット曲", "ワン・ヒット・ワンダー", "音楽理論", "TikTokヒット"],
      [TOPIC_IDS.GAMING]: ["任天堂", "プレイステーション", "Xbox", "PCゲーム", "RPG", "FPS", "ライブサービスゲーム", "レトロゲーム", "eスポーツ", "マインクラフト", "ポケモン", "ゼルダ", "マリオ", "インディーゲーム", "UGCプラットフォーム", "クロスプラットフォームゲーム"],
      [TOPIC_IDS.SPORTS]: ["サッカー", "バスケットボール", "野球", "テニス", "ゴルフ", "F1", "オリンピック", "ボクシング", "総合格闘技", "クリケット", "ラグビー", "水泳", "ウィンタースポーツ", "スケートボード", "レスリング", "ワールドカップ"],
      [TOPIC_IDS.TECH]: ["人工知能", "スマートフォン", "クラウドコンピューティング", "ソーシャルメディア", "コーディング", "サイバーセキュリティ", "宇宙技術", "空間コンピューティング", "ブロックチェーン", "ロボット", "コンピュータハードウェア", "ビッグデータ", "スタートアップ", "ハッカー", "ゲーミング技術", "生成AIアプリ"],
      [TOPIC_IDS.MYTHOLOGY]: ["ギリシャ神話", "北欧神話", "エジプト神話", "ローマ神話", "日本伝承", "中国神話", "ケルト神話", "アズテック神話", "ヒンドゥー神話", "ネイティブ・アメリカン", "伝説の怪物", "叙事詩の英雄", "冥界", "創世神話", "神々のパンテオン", "トリックスター"],
      [TOPIC_IDS.LITERATURE]: ["シェイクスピア", "古典小説", "ディストピア小説", "ファンタジー", "SF小説", "詩", "ホラー", "ミステリー", "コミック・漫画", "ノーベル賞作家", "おとぎ話", "ギリシャ叙事詩", "ロシア文学", "アメリカ文学", "イギリス文学", "ウェブ小説"],
      [TOPIC_IDS.NATURE]: ["哺乳類", "鳥類", "昆虫", "海洋生物", "恐竜", "熱帯雨林", "砂漠", "異常気象", "花", "木々", "国立公園", "生存技術", "進化", "絶滅危惧種", "菌類", "宝石・鉱物"],
      [TOPIC_IDS.FOOD]: ["イタリア料理", "フランス料理", "メキシコ料理", "日本料理", "中華料理", "インド料理", "韓国料理", "デザート", "ワイン", "スペシャルティコーヒー", "高タンパク食", "ストリートフード", "ファストフード", "ベーキング", "ヴィーガン", "ノンアルコールドリンク"],
...
const ZH_TRANSLATIONS: TranslationData = {
  ...
  topics: {
    ...
    subtopics: {
      ...
      [TOPIC_IDS.SCIENCE]: ["量子物理", "遗传学", "有机化学", "神经科学", "植物学", "天文学", "地质学", "热力学", "海洋生物学", "进化论", "粒子物理学", "免疫学", "古生物学", "气候科学", "机器人学", "生态学"],
      [TOPIC_IDS.ARTS]: ["印象派", "文艺复兴艺术", "AI 艺术与提示词设计", "超现实主义", "数字插画", "现代主义", "雕塑", "平面设计", "时尚核心趋势", "手机摄影", "街头艺术", "沉浸式艺术体验", "抽象表现主义", "陶瓷复兴", "现代书法", "哥特式建筑"],
      [TOPIC_IDS.GENERAL]: ["AI 监管", "创作者经济", "发明", "世界首都", "货币", "诺贝尔奖", "恐惧症", "品牌标志", "加密货币", "病毒式趋势", "棋盘游戏", "纸牌游戏", "超级英雄", "数字健康", "AI 智能体", "EV 品牌"],
      [TOPIC_IDS.GEOGRAPHY]: ["首都", "地标", "山脉", "河流", "沙漠", "岛屿", "火山", "国旗", "人口统计", "气候带", "海洋", "美国各州", "欧洲国家", "亚洲城市", "非洲国家", "地缘热点"],
      [TOPIC_IDS.MOVIES]: ["奥斯卡", "科幻", "恐怖", "漫威电影宇宙", "星球大战", "皮克斯", "流媒体原创", "系列重启", "著名导演", "电影原声带", "邪典电影", "动画电影", "法国电影", "A24 与独立电影", "特效", "电影反派"],
      [TOPIC_IDS.MUSIC]: ["摇滚乐", "流行音乐", "爵士乐", "古典音乐", "嘻哈", "K-Pop", "电子舞曲", "重金属", "蓝调", "乡村音乐", "歌剧", "乐器", "90年代金曲", "一曲成名", "乐理", "TikTok 热门曲"],
      [TOPIC_IDS.GAMING]: ["任天堂", "PlayStation", "Xbox", "PC游戏", "RPG", "FPS", "长线运营游戏", "复古游戏", "电子竞技", "我的世界", "精灵宝可梦", "塞尔达传说", "马里奥", "独立游戏", "UGC 平台", "跨平台游戏"],
      [TOPIC_IDS.SPORTS]: ["足球", "篮球", "棒球", "网球", "高尔夫", "一级方程式", "奥运会", "拳击", "综合格斗", "板球", "橄榄球", "游泳", "冬季运动", "滑板", "摔跤", "世界杯"],
      [TOPIC_IDS.TECH]: ["人工智能", "智能手机", "云计算", "社交媒体", "编程", "网络安全", "太空技术", "空间计算", "区块链", "机器人", "计算机硬件", "大数据", "初创公司", "黑客", "游戏技术", "生成式 AI 应用"],
      [TOPIC_IDS.MYTHOLOGY]: ["希腊神话", "北欧神话", "埃及神话", "罗马神话", "日本民间传说", "中国神话", "凯尔特神话", "阿兹特克神话", "印度神话", "美洲原住民", "传奇怪物", "史诗英雄", "冥界", "创世神话", "诸神体系", "恶作剧之神"],
      [TOPIC_IDS.LITERATURE]: ["莎士比亚", "经典小说", "反乌托邦小说", "奇幻", "科幻书籍", "诗歌", "恐怖", "悬疑", "漫画", "诺贝尔奖得主", "童话", "希腊史诗", "俄罗斯文学", "美国文学", "英国文学", "网络小说"],
      [TOPIC_IDS.NATURE]: ["哺乳动物", "鸟类", "昆虫", "海洋生物", "恐龙", "雨林", "沙漠", "极端天气", "花卉", "树木", "国家公园", "生存技能", "进化论", "濒危物种", "真菌", "宝石与矿物"],
      [TOPIC_IDS.FOOD]: ["意大利美食", "法国美食", "墨西哥美食", "日本料理", "中国美食", "印度美食", "韩国料理", "甜点", "葡萄酒", "精品咖啡", "高蛋白饮食", "街头小吃", "快餐", "烘焙", "素食", "无酒精饮品"],
